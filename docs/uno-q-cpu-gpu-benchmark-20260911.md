...
2026-09-12に候補を再学習し、学習・検証・独立テストの各splitが中央12点を含む全60位置を網羅するよう改訂した。完全な収録セッション単位で分離した独立テスト2,507件の結果を示す。下のUNO Q実機速度は旧parityで測った値なので、精度評価と速度評価の母集団は区別する。

| 指標 | CPU dynamic MLP | GPU FP16 CNN |
|---|---:|---:|
| 60点top-1 | 95.37% | 95.45% |
| 12エリア精度 | 99.16% | 99.36% |
| MAP XY平均距離 | 2.66 mm | 2.63 mm |
| Expected XY平均距離 | 3.47 mm | 2.73 mm |
| Direct XY平均距離 | 27.56 mm | 17.73 mm |
| ECE | 0.0117 | 0.0184 |
