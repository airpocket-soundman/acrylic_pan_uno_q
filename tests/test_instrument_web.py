...
class InstrumentWebTests(unittest.TestCase):
    ...
    def test_instrument_page_uses_existing_live_inference_api(self):
        ...
        self.assertNotIn("/api/ai/latest", script)
        ...
        self.assertNotIn("/api/audio/note.wav", script)
        self.assertNotIn("decodeAudioData", script)
        self.assertNotIn("audio.prime", script)
